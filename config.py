...
OWNER_ID = list(map(int, getenv("OWNER_ID", "2015863406").split()))

HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)

UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://https://github.com/JotaroDioBrando/KontoryuV2")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+-DQPMeTV8MI4ZTYx")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/prsldfn")
